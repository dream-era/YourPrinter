...
--
-- This is genuinely new — run this BEFORE 0007/0008 from the payment layer
-- package if you haven't already, since those migrations assume `orders`
-- and `shops` already exist. Recommended order:
--   0009_core_schema.sql  (this file)
--   0007_shop_payment_settings.sql
--   0008_orders_payment_columns.sql   (safe no-op if columns already match)
-- ============================================================================
...
create trigger trg_orders_updated_at
  ...
  for each row execute function set_updated_at(); -- defined in 0007 migration; create here too if run standalone

-- (safe to define again if 0007 hasn't run yet)
